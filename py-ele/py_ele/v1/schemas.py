...
filters = {
    ('welcome', 'GET'): {200: {'headers': None, 'schema': {'additionalProperties': False, 'required': ['msg'], 'type': 'object', 'properties': {'msg': {'type': 'string'}}}}},
    ('car_car_id_floor_current', 'GET'): {200: {'headers': None, 'schema': {'additionalProperties': False, 'type': 'object', 'properties': {'name': {'type': 'string'}, 'id': {'type': 'string'}}}}, 404: {'headers': None, 'schema': None}},
    ('floor_count', 'GET'): {200: {'headers': None, 'schema': {'additionalProperties': False, 'required': ['count'], 'type': 'object', 'properties': {'count': {'type': 'integer', 'format': 'int32'}}}}},
    ('admin_inventory_pwd', 'GET'): {200: {'headers': None, 'schema': {'items': {'additionalProperties': False, 'type': 'object', 'properties': {'name': {'type': 'string'}, 'id': {'type': 'string'}}}, 'type': 'array'}}, 401: {'headers': None, 'schema': None}},
}
